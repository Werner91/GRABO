...
public class Spieleinstellungen extends JDialog implements ActionListener{
	...
	public Spieleinstellungen(Hauptfenster hauptfenster){
		...
		wartezeit_slider.setMajorTickSpacing(2000); //Abst‰nde im Groﬂraster
		...
		verzoegerung_slider.setMajorTickSpacing(2000); //Abst‰nde im Groﬂraster
		...
		wartezeit_vor_dem_schuss.setMajorTickSpacing(2000); //Abst‰nde im Groﬂraster
		...
		panel.add(new JLabel("Verzˆgerung eines Schuess: "));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand() == "abbrechen"){
			Spieleinstellungen.this.dispose(); // Fenster wieder Schlieﬂen
		}
